                    ...
                    <div class="flex flex-wrap justify-center">
                        <div class="flex justify-center w-full">
                            <div class="relative">
                                ...
                                @if ($pet->image)
                                <div class="h-32 w-32 border-white rounded-full align-middle border-8 absolute -m-16 -ml-18 lg:-ml-16 max-w-[150px]" style=" background-image: url('{{ url(Storage::url($pet->image->url)) }}'); background-size: contain">
