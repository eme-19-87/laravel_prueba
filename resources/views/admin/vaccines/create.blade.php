...
@section('content')
    <div class="card">
      ...
      <h2 class="mt-4 ml-4 text-lg">Nueva<strong class="text-blue-800w"> Vacuna</strong> </h2>
        <div class="card-body">
            {!! Form::open(['route' => 'admin.vaccines.store', 'autocomplete' => 'off']) !!}
            ...
            <div class="form-group">
              <p class="font-weight-bold mb-1">vacuna:</p>
