<x-app-layout>
<section class="bg-white bg-[url(https://images.unsplash.com/photo-1553530979-7ee52a2670c4?auto=format&fit=crop&q=80&w=3302&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] backdrop-blur-2xl">

    <div class="backdrop-blur-2xl w-screen">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 ">
            <h1 class="text-white text-3xl flex justify-center font-extrabold mt-10 mb-10">Posts y Anuncios</h1>
            ...
            @foreach ($posts as $post)
                ...
                @endphp
                @if($post->image)
                    <article style="background-image: url('{{ url(Storage::url($post->image->url)) }}'); background-position: center; " class="bg-black/20 border border-gray-200 rounded-lg p-8 md:p-12 @if($loop->first) col-span-2 mb-8 @endif">
