...
<section class="bg-white">
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
    ...
    @foreach ($posts as $post)
            <article  class="@if($post->image) bg-[url({{url(Storage::url($post->image->url))}})] @else bg-[url(https://images.unsplash.com/photo-1552832230-c0197dd311b5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1592&q=80)] @endif bg-black/20 border border-gray-200 rounded-lg p-8 md:p-12 @if($loop->first) col-span-2 mb-8 @endif">
