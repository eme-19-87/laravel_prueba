...
<div class="mx-auto grid grid-cols-2 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        ...
        <div class="lg:pr-4">
            <div class="lg:max-w-lg">
              ...
              <div class="flex items-center mt-6 mb-10">
                <img class="object-cover object-center w-10 h-10 rounded-full" src="{{ $post->user->profile_photo_url }}" alt="">
                <div class="mx-4">
