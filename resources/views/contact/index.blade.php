<x-app-layout>
    <section style='background-image: url("https://plus.unsplash.com/premium_photo-1675437553489-0ddf979f299a?auto=format&fit=crop&q=80&w=1800&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")' class="text-gray-600 z-30 body-font relative">
        <main class="h-screen flex items-center justify-center">
                    ...
                    <div
                        ...
                        <div class="flex justify-center justify-items-center gap-6 md:px-0">
                            ...
                            <div class="justify-center mb-4">
                                Instagram
                                <a href="https://instagram.com/iden.mac?utm_source=qr&igshid=MzNlNGNkZWQ4Mg=="
                                    className="leading-7 text-sm text-gray-600 font-semibold justify-center flex mt-2">
                                    <svg width="45" height="40" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
            ...
            <div id="web3forms__widget" x-data="{ open: false }" x-init="() => setTimeout(() => open = false, 2000)">
                    ...
                    <div class="bg-gray-50 flex-grow p-6">
                        <form action="{{route('sendemail')}}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="subject" id="subjet" placeholder="Podria ayudar en..." required
                                    class="w-full px-3 py-2 bg-white placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300">
                                <div class="empty-feedback invalid-feedback text-red-400 text-sm mt-1">
                                    Por favor rellena este campo.
                                </div>
                ...
                <button id="w3f__widget--btn" @click="open = !open"
                    class="fixed z-40 right-5 bottom-5 shadow-lg flex justify-center items-center w-14 h-14 bg-lime-700 rounded-full focus:outline-none transition duration-300 ease">
