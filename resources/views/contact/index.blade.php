<x-app-layout>
    <section class="text-gray-600 z-30 body-font relative">
        ...
        <main
            style='background-image: url("https://plus.unsplash.com/premium_photo-1675437553489-0ddf979f299a?auto=format&fit=crop&q=80&w=1800&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")'
            class="h-screen flex flex-col space-y-2 items-center justify-center">
            <div class="flex flex-col items-center justify-center -translate-x-1/2">
                ...
                <div class="container px-5 py-24 mx-auto flex">
                    <div
                        class="lg:w-9/12 md:w-9/12 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative shadow-md">
